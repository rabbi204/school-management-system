                ...
                <div class="col-12">
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-black">
                            ...
                            <a href="{{ route('profile.edit') }}" class="btn btn-success btn-rounded float-right">Edit Profile</a>
                            <h6 class="widget-user-desc">User Type: {{ $user->user_type }}</h6>
                            <h6 class="widget-user-desc">User Email: {{ $user->email }}</h6>
                        </div>
                        <div class="widget-user-image">
                            <img class="rounded-circle" src="{{ (!empty($user->image) ? asset($user->image) : asset('upload/no_image.jpg') ) }}" alt="User Avatar" />
                        </div>
