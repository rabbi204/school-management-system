							...
							<form method="POST" action="{{ route('register') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" required autocomplete="new-password">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password" name="password_confirmation" required autocomplete="new-password">
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-12">
									    <div class="checkbox text-white">
                                            ...
                                            <label for="terms">I agree to the <a href="{{ route('terms.show') }}" class="text-warning"><b>Terms</b></a></label>
									   </div>
									</div>
                                    @endif --}}
									<!-- /.col -->
